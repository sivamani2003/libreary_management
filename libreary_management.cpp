...
int main()
{
    ...
    while (exit != 1)
    {
        cout<<"\t\t\t\t**********************************************************************"<<endl;
        cout<<flush;
        cout << "\t\t\t\t\t\t\tWELCOME TO THE SRM LIBREARY" << endl;
        cout << flush;
        cout<<"\t\t\t\t**********************************************************************"<<endl;
        cout << flush;
        cout << "ARE YOU NEW USER OF SRM LIBREARY IF YES Y OR  N " << endl;
        cout << flush;
        char new_user;
        cin >> new_user;
        if (new_user == 'y'|| new_user=='Y')
        {
            ...
            cout<<"\t\t\t\t**********************************************************************"<<endl;
            cout << flush;
            cout <<"\t\t\t\t\t\tWELCOME TO SRM LIBREARY REGISTRATION PAGE" << endl;
            cout<<"\t\t\t\t**********************************************************************"<<endl;
            cout << flush;
            cout << flush;
            ...
            cin >> new_user_name;
            cout << endl
                 << "ENTER THE ID OF YOUR SRM  LIBREARY ACCOUNT:" << endl;
            cout << flush;
            cin >> new_user_id;
            ...
            cout << "You have been registered to SRM Library. Please login again with your Credentials." << endl;
            cout << flush;
            continue;
        }
            ...
            if (userDatabase.validId(existing_user_id, &userDatabase) == 1)
            {
                if (userDatabase.validPassword(existing_user_id, existing_user_password, &userDatabase) == 1)
                {
                    ...
                    while (1)
                    {
                        ...
                        else if (existing_user_type == "professor")
                        {
                            existing_user_number_of_book_issued = userDatabase.Search(existing_user_id, &userDatabase).number_of_book_issued;
                            existing_user_ListOfBookIssued = userDatabase.Search(existing_user_id, &userDatabase).ListOfBookIssued;
                            cout << "select 1 for showing the list of books issued by you \nselect 2 for showing the list of all the available books" << endl;
                        ...
                        else if (existing_user_type == "librarian")
                        {
    ...
    cout<<"The input given is wrong"<<endl;
    goto menu;
    return 0;
}